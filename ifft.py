...
# Healthy 信号
axs[0][0].plot(healthy_time, healthy_value, label='Original Healthy', color='green', alpha=0.7)
axs[0, 0].set_title('Original Healthy Signal')
axs[0, 0].set_ylabel('Amplitude')
axs[0, 0].grid(True)

axs[0, 1].plot(healthy_time, reconstructed_healthy, label='Reconstructed Healthy', color='lime', alpha=0.7)
axs[0, 1].set_title('Reconstructed Healthy Signal')
axs[0, 1].grid(True)


# Neuropathy 信号
axs[1, 0].plot(neuropathy_time, neuropathy_value, label='Original Neuropathy', color='blue', alpha=0.7)
axs[1, 0].set_title('Original Neuropathy Signal')
axs[1, 0].set_ylabel('Amplitude')
axs[1, 0].grid(True)

axs[1, 1].plot(neuropathy_time, reconstructed_neuropathy, label='Reconstructed Neuropathy', color='cyan', alpha=0.7)
axs[1, 1].set_title('Reconstructed Neuropathy Signal')
axs[1, 1].grid(True)


# Myopathy 信号
axs[2, 0].plot(myopathy_time, myopathy_value, label='Original Myopathy', color='red', alpha=0.7)
axs[2, 0].set_title('Original Myopathy Signal')
axs[2, 0].set_xlabel('Time (s)')
axs[2, 0].set_ylabel('Amplitude')
axs[2, 0].grid(True)

axs[2, 1].plot(myopathy_time, reconstructed_myopathy, label='Reconstructed Myopathy', color='orange', alpha=0.7)
